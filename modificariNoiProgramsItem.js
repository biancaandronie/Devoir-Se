...
export default class ProgramsItem extends Component{
    ...
    componentWillUnmount() {
        IS_STB_DEVICE && ((this.props.type === "tv-program") || (this.props.type === "replay-program")) && programItem.elem && programItem.elem.removeEventListener("sn:enter-up", this.openItem.bind({ item: this, program: this.programItem.program }));
    };

    componentDidUpdate() {
        IS_STB_DEVICE && ((this.props.type === "tv-program") || (this.props.type === "replay-program")) && programItem.elem.addEventListener("sn:enter-up", this.openItem.bind({ item: this, program: this.programItem.program }));
    };
        ...
        if(program) {
            ...
            return (
                <div className="program-item-container" style={this.getItemMargin(programs.length)} key={carouselLength} >
                    <div ref={elem => this.programItem = { elem}} onKeyUp={(e) => this.openItem(e)} id={elementsIdPrefix + "more"} className={itemStyle} listindex={carouselLength}>
